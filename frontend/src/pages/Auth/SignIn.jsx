    ...
    <div className="min-h-screen bg-[#FDFDFC] flex flex-col font-sans text-slate-900 selection:bg-slate-200">
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm mb-10 text-center">
          ...
          <h2 className="text-3xl font-medium tracking-tight text-slate-900 mb-3">Welcome back.</h2>
          <p className="text-slate-500 font-light">Continue creating something worth hearing.</p>
        </div>
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <p className="mt-10 text-center text-sm text-slate-500">
            ...
            <Link to="/signup" className="font-semibold leading-6 text-slate-900 hover:text-slate-700 transition-colors">
              Create one
            </Link>
          </p>
        </div>
